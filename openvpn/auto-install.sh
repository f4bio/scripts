...
# Tested on BySH Debian 5.0 template (64bit), should work on any debian based vps templates.


# Originally by John Malkowski for vpsnoc.com
# Modified for Bytesized-Hosting by Christoffer M.
...
For support/bug reports please join in at #bytesized on irc.seednet-irc.org"
