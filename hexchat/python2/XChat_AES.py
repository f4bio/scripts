...
g_dh1080 = 2
p_dh1080 = int('FBE1022E23D213E8ACFA9AE8B9DFAD'+'A3EA6B7AC7A7B7E95AB5EB2DF85892'+'1FEADE95E6AC7BE7DE6ADBAB8A783E'+'7AF7A7FA6A2B7BEB1E72EAE2B72F9F'+'A2BFB2A2EFBEFAC868BADB3E828FA8'+'BADFADA3E4CC1BE7E8AFE85E9698A7'+'83EB68FA07A77AB6AD7BEB618ACF9C'+'A2897EB28A6189EFA07AB99A8A7FA9'+'AE299EFA7BA66DEAFEFBEFBF0B7D8B', 16)
...
class KeyMap(dict):
    def __get_real_key(self, key):
        ...
        same_nick_keys = [k[1] for k in self.keys() if k[0] == nick]
